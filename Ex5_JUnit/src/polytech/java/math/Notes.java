...
public class Notes {
	...
	public Notes addNote(float note)throws NoteIllegalException
	{
		if (note > 20 || note < 0) 
			throw new NoteIllegalException();//Exception("Le note doit >=0 et <= 20");
		noteList.add(note);
		return this;
	}
...
//		}
	...
	public class NoteIllegalException extends Exception{}
}
